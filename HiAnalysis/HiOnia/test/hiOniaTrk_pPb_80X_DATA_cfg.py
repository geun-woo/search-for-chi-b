...
applyEventSel  = True     # event selection
#----------------------------------------------------------------------------
...
options.inputFiles = 'file:/cms/ldap_home/gekim/Data/pPbdata.root'
...
process.onia2MuMuPatGlbGlb.dimuonSelection          = cms.string("mass>6 && mass<20")
...
# For conversions
# process.load("HiAnalysis.HiOnia.allConversions_cfi")

process.hionia = cms.EDAnalyzer('HiOniaAnalyzer',
                                #-- Collections
                                srcConversion       = cms.InputTag("allConversions"),                  # gnu
                                ...
                                useGeTracks = cms.untracked.bool(True),
...
if applyEventSel:
    ...
    process.oniaSequence.replace(process.hionia , process.PAprimaryVertexFilter * process.NoScraping * process.hfCoincFilter * process.hionia )
